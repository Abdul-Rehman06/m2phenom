...
export function ClientAuthLayout() {
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-white">
      ...
      {/* RIGHT SIDE (Light) */}
      <div className="w-full lg:w-1/2 flex flex-col bg-surface-50 text-gray-900 relative items-center justify-center">
        {/* Top Header Icons */}
        <div className="flex justify-end gap-6 p-6 lg:p-8 text-xs font-bold text-gray-500 w-full">
        ...
        {/* Footer */}
        <div className="w-full p-6 lg:p-8 text-right text-xs text-gray-500 font-bold">
          &copy; {new Date().getFullYear()} <span className="text-primary-600">M2 Phenom</span>. All Rights Reserved.
        </div>
      </div>
    </div>
  );
