  ...
  return (
    <div className="w-full max-w-[460px] bg-[#1A1A1F] rounded-2xl p-8 lg:p-10 border border-white/5 relative shadow-2xl">
      ...
      <div className="flex flex-col items-center mb-8 relative z-10">
        ...
        <p className="text-sm text-gray-400">Sign up for your M2 Phenom dashboard</p>
      </div>
      ...
      <div className="relative flex items-center justify-center mb-8">
        ...
        <div className="relative bg-[#1A1A1F] px-4 text-xs text-gray-500 font-medium">
          Already have an account? <Link to="/auth/login" className="text-primary-500 hover:text-primary-400 transition-colors">Login</Link>
        </div>
      </div>
      ...
      <form onSubmit={handleRegister} className="space-y-4">
        ...
        <Button type="submit" className="w-full h-12 mt-2 bg-brand-gradient text-white font-bold tracking-wide border-0 shadow-lg shadow-primary-500/20 hover:shadow-primary-500/40 rounded-lg">
          REGISTER NOW
        </Button>
      </form>
