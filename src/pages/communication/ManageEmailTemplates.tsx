...
const MOCK_TEMPLATES = [
  { id: 1, title: 'Welcome Email', date: 'January-03-2026' },
  { id: 2, title: 'Update Request', date: 'November-05-2025' },
  { id: 3, title: 'Results Available', date: 'November-01-2025' },
];
      ...
      <div className="relative min-h-screen pb-12 w-full flex flex-col">
        ...
        <ContentWrapper className="relative z-10 w-full max-w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-8">
          ...
          <div className="mb-6 w-full">
            <h1 className="text-2xl font-bold text-gray-900 mb-1">Manage Email Templates</h1>
          </div>
